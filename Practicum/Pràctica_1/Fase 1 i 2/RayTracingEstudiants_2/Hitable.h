 ...
 * Author: anna
 *
 * Created on 17 de enero de 2018, 17:45
 */
...
{
public:
    float     t; // t del raig on s'ha intersecat. t: quan li has de multiplicar al raig desde lorigen per arribar fins al pla
    ...
    //  "operator =" per la classe  HitInfo
