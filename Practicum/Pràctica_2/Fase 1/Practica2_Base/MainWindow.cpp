    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(this->ui->action_obre_escena, SIGNAL(triggered()), glWidget, SLOT(newScene()));
    ...
    connect(this->ui->action_goraud_tex, SIGNAL(triggered()), glWidget, SLOT(activaGouraudTex()));
