...
Scene *FactoryConcurso::createScene() {
    ...
    pilotaAdvance->transf = new Translate1(vec3(-0.08,0,0));
    ...
    pilotaUp->transf = new Translate1(vec3(0,0.12,0));
    ...
    pilotaLeft->frameFinal = 598;
    pilotaLeft->transf = new Translate1(vec3(-0.45,0,0));
